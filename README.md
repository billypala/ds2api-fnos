...
> **当前版本：v3.7.2**（Native 应用，自包含 Go 静态二进制，离线可装）

1. **获取 `.fpk`**：
   - 方式 A：直接下载 `release/ds2api-3.7.2.fpk.b64`（Base64 文本，见 [release 说明](release/README.md) 解码）
   - 方式 B：点击上方 **Releases** 页下载 `ds2api.fpk`（推荐 v3.7.2）
   - 方式 C：自行构建（见下节）
